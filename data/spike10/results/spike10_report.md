# Spike 10 - out-of-sample validation: RRUFF real powder XRD
...
1. RRUFF archive scans are fast/short: peak counts 436-6321 << 1e5 (the spike-05 calibrated floor for a refinement claim), so verification evidence is reported as 'statistics-below-gate' -- the refinement cannot claim verification, but the identification verdict is unaffected.
