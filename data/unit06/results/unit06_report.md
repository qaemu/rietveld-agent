...
- Newly fetched from COD: 9 (first-introduced by unit 06: all but the three pre-existing fixture CODs [1000041, 1009000, 9011025]).
...
- Unit 04/05 re-run on the catalog-backed library: e2e green (PbSO4 (anglesite) same-anode + cross-anode; cu_quartz resolves to GaAsO4 (quartz homeotype); NaCl eval now simulates the real halite COD 1000041; family-aware margins >= 0.9).
