...
- Noiseless protocol: the observed pattern is the deterministic GSAS-II simulation of the catalog CIF (same protocol as catalog fingerprints). Noise robustness is spike 05's mandate; real-data Rwp values will be larger -- the decision signal is lowest-Rwp family + policy bounds, not absolute Rwp.
