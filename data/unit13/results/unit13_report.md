# Unit 13: multiphase Rietveld QPA (GSAS-II) on SRM 2686a clinker

- Goal: quantitative phase analysis of the 4 real NIST clinker patterns using ONLY the published phase set, with the COD CIFs identified by unit 12 (alite 1538413, belite 2312428, ferrite 1200009, periclase 1000053, C3A 1000039).
...
- Periclase is a *minor* phase (2-17 wt%): its 2 strong lines (200/220) drive its scale; the unit-12 window study showed those lines match to <0.003 Å, which is what makes the scale physical.