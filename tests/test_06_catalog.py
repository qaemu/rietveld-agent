"""Unit 06: COD-backed catalogue release + rebuilt runtime library.

Checks the artefacts written by benchmarks/protocols/06_catalog_build.py:
  data/catalog/schemas/catalog_release.v0.json
  data/catalog/releases/catalog_0.1.1.json
  data/candidates/library.json
  data/unit06/results/unit06_report.json

Pinned criteria (from the unit 06 gate):
...
REPORT = os.path.join(ROOT, "data", "unit06", "results",
                      "unit06_report.json")
